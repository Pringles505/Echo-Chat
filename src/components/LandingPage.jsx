...
const Footer = () => {
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { label: t('footer.product.status'), href: '#' },
      ],
    },
    {
      ...
      links: [
        ...
        { label: t('footer.resources.guides'), href: '/documentation/guides' },
        { label: t('footer.resources.apiPlayground'), href: '/api-playground' },
        { label: t('footer.resources.blog'), href: '/blog' },
      ],
    },
    {
      title: t('footer.communitySection.title'),
      links: [
        { label: t('footer.communitySection.community'), href: '/community' },
        { label: t('footer.communitySection.discord'), href: '#' },
        { label: t('footer.communitySection.github'), href: '#' },
        { label: t('footer.communitySection.twitter'), href: '#' },
      ],
    },
    {
  ...
  const legalLinks = [
    { label: t('footer.legal.privacyPolicy'), href: '/legal/privacy-policy' },
    { label: t('footer.legal.termsOfService'), href: '/legal/terms-of-service' },
    { label: t('footer.legal.cookiePolicy'), href: '/legal/cookie-policy' },
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <p className="text-zinc-500 text-sm">
            © {currentYear} Echo. {t('footer.rights')}
          </p>
