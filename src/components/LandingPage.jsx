  ...
  return (
    <div className="relative min-h-screen bg-black text-white selection:bg-violet-500/30 font-sans overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <main>
          <Hero />
          <SectionWrap><Features /></SectionWrap>
          <SectionWrap><CodeTypingSection /></SectionWrap>
          <SectionWrap><HeroAiDemo /></SectionWrap>
          <SectionWrap><HeroAnimation /></SectionWrap>
          <SectionWrap><CipherPlayground /></SectionWrap>
          <SectionWrap><SecurityDocs /></SectionWrap>
