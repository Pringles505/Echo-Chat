...
const features = [
  {
    ...
    description:
      "Military-grade X3DH protocol ensures your messages are encrypted before transmission.",
    color: "text-blue-400",
    bg: "bg-blue-400/10",
  },
  {
    ...
    description:
      "We never have access to your data - privacy by cryptographic design.",
  ...
  },
  {
    ...
    description:
      "Dynamic key rotation protects past communications from future breaches.",
  ...
  },
  {
    ...
    description:
      "256-bit encrypted group conversations with up to 500 participants.",
  ...
  },
  {
    ...
    title: "Open Source",
    description:
      "Auditable codebase with reproducible builds for transparency.",
...
const Features = () => {
  ...
  return (
    <section
      id="features"
      className="py-24 px-4 bg-gradient-to-b from-[var(--color-primary)]/5 to-transparent"
      ref={ref}
    >
      <div className="container mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="text-xl text-[var(--color-text)]/70 max-w-3xl mx-auto">
            Every feature is engineered with your fundamental right to privacy
            in mind
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div
                className={`w-14 h-14 ${feature.bg} rounded-lg flex items-center justify-center mb-6`}
              >
              ...
              <div className="absolute bottom-5 right-5 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div
                  className={`w-2 h-2 rounded-full ${feature.bg.replace(
                    "bg",
                    "bg-opacity-100"
                  )}`}
                ></div>
...
>
  <div className="inline-flex items-center gap-4 bg-[var(--color-primary)]/10 px-8 py-4 ">
    <span className="font-medium text-lg">
      All communications protected by Echo Protocol
    </span>
    <div className="flex-shrink-0 w-12 h-12 relative">
      <img
        src="EchoProtocolLogo.png"
        alt="Echo Protocol Logo"
