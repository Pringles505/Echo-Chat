      ...
      <div className='flex-1 flex items-center justify-center px-4 py-12 pt-28'>
        <div className='w-full max-w-md'>
          ...
          <div className='text-center mb-8'>
            ...
            <h1 className='text-3xl font-bold text-white mb-2'>{t('auth.joinEcho')}</h1>
            <p className='text-neutral-400'>{t('auth.joinEchoDesc')}</p>
          </div>
          ...
          <div className='relative mb-6'>
            ...
            <div className='relative flex justify-center text-sm'>
              <span className='px-2 bg-black text-white/40'>{t('auth.orSignUpWith')}</span>
            </div>
          </div>
