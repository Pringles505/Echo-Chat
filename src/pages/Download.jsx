...
import { Monitor, Apple, Smartphone, ShieldCheck, Github, ExternalLink, Download } from "lucide-react";
import Navbar from "../components/HomepageComponents/Navbar";
import Footer from "../components/HomepageComponents/Footer";
import PageWrapper from "../components/common/PageWrapper";

const COMING_SOON_ICONS = [
  { key: "macos",   Icon: Apple,       color: "text-white/50",   bg: "bg-white/5",        border: "border-white/10" },
  { key: "android", Icon: Smartphone,  color: "text-green-400/50", bg: "bg-green-500/5",  border: "border-green-500/10" },
  { key: "ios",     Icon: Smartphone,  color: "text-blue-400/50",  bg: "bg-blue-500/5",   border: "border-blue-500/10" },
];
      ...
      <main className="pt-28 pb-24 px-4 sm:px-6">
          ...
          <div className="relative flex flex-col sm:flex-row sm:items-center gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs bg-violet-500/20 text-violet-300 px-2 py-0.5 rounded-full border border-violet-500/30">{win.badge}</span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <a href="https://github.com/Enriquefft/Echo/releases/latest"
                ...
                <a href="https://github.com/Enriquefft/Echo/releases"
                  target="_blank" rel="noopener noreferrer"
        ...
        <div className="max-w-2xl mx-auto grid grid-cols-3 gap-4 mb-16">
          {COMING_SOON_ICONS.map(({ key, Icon, color, bg, border }, i) => {
            ...
            return (
              <motion.div key={key} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4, delay: 0.3 + i * 0.07 }}
        ...
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45, delay: 0.5 }}
          ...
          <h3 className="text-sm font-semibold text-white/60 uppercase tracking-widest mb-4">{sec.title}</h3>
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }}
          ...
          <a href="https://github.com/Enriquefft/Echo" target="_blank" rel="noopener noreferrer"
