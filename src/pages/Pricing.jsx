...
import {
  Check, ArrowRight, Zap, Shield, Building2, ChevronDown,
} from 'lucide-react';
...
const plans = [
  ...
  },
  {
    ...
    icon: Shield,
    monthly: 12,
    description: 'For growing teams that need advanced security, integrations, and priority support.',
  ...
  },
  {
    ...
    icon: Building2,
    monthly: null,
    description: 'Custom deployment for large organisations with compliance and security requirements.',
    users: '50+ users',
    cta: 'Contact sales',
    ctaLink: '/contact-us',
    highlighted: false,
    ...
    <div className="min-h-screen bg-neutral-950 text-white overflow-x-hidden">
      ...
      <section className="relative pt-44 pb-28 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <motion.h1 {...fu(0.05)} className="text-6xl sm:text-8xl font-extrabold tracking-tighter leading-none mb-6">
            Security that<br />
            ...
            return (
              ...
              >
                ...
                <div className={`w-10 h-10 rounded-xl flex items-center justify-center mb-5 ${
                  ...
                  <Icon className={`w-5 h-5 ${plan.highlighted ? 'text-violet-400' : 'text-white/40'}`} />
                </div>
      ...
      <section className="py-16 border-y border-white/[0.06]">
        <div className="max-w-4xl mx-auto px-6">
          <motion.p {...fu(0)} className="text-center text-xs uppercase tracking-[0.2em] text-white/20 mb-8">
            Secure checkout via
          </motion.p>
          <motion.div {...fu(0.05)} className="flex flex-wrap justify-center gap-3">
            ...
            <div className="flex items-center justify-center px-5 py-2.5 rounded-xl bg-white/[0.04] border border-white/10 min-w-[80px]">
              <span className="text-base font-extrabold italic tracking-tight text-white">VISA</span>
            </div>
            ...
            <div className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/[0.04] border border-white/10">
              <span className="font-extrabold text-sm leading-none">
                <span style={{ color: '#009cde' }}>Pay</span><span style={{ color: '#fff', opacity: 0.9 }}>Pal</span>
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#635bff]/10 border border-[#635bff]/30">
              <span className="text-sm font-extrabold" style={{ color: '#635bff' }}>stripe</span>
            </div>

            {/* Amex */}
            <div className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#016fd0]/10 border border-[#016fd0]/30">
              <span className="text-xs font-bold tracking-widest" style={{ color: '#016fd0' }}>AMEX</span>
            </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <motion.p {...fu(0)} className="text-xs uppercase tracking-[0.2em] text-white/25 text-center mb-4">
            Compare plans
          </motion.p>
          <motion.h2 {...fu(0.05)} className="text-4xl sm:text-5xl font-extrabold tracking-tighter text-center mb-16">
            Everything side by side
          </motion.h2>

          <motion.div {...fu(0.1)} className="rounded-2xl border border-white/[0.08] overflow-hidden">
            {/* header row */}
      ...
      <section className="py-16 border-y border-white/[0.06] overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 mb-10">
          <motion.p {...fu(0)} className="text-center text-xs uppercase tracking-[0.2em] text-white/20">
            Trusted by teams at
          </motion.p>
        </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <motion.h2 {...fu(0.05)} className="text-4xl sm:text-5xl font-extrabold tracking-tighter mb-14">
            Common questions
          </motion.h2>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-5xl sm:text-6xl font-extrabold tracking-tighter mb-4 leading-tight">
                Not sure which<br />plan fits you?
              </h2>
              <p className="text-white/40 mb-10 max-w-md mx-auto">
                Our team will help you find the right plan for your organisation&apos;s security needs.
              </p>
