...
const ALL_CONTRIBUTORS = [
  { rank: 1,  name: 'David K.',    handle: '@davidk',    avatar: '👨‍🏫', role: 'Community Lead',        commits: 850, prs: 142, stars: 1240, badge: 'core',    joined: 'Jan 2024' },
  { rank: 2,  name: 'Sarah J.',    handle: '@sarahj',    avatar: '👩‍💻', role: 'Core Maintainer',       commits: 720, prs: 118, stars: 980,  badge: 'core',    joined: 'Feb 2024' },
  { rank: 3,  name: 'Elena R.',    handle: '@elenar',    avatar: '🎨',   role: 'UI/UX Designer',        commits: 510, prs:  87, stars: 430,  badge: 'design',  joined: 'Mar 2024' },
  { rank: 4,  name: 'Marcus T.',   handle: '@marcust',   avatar: '🔐',   role: 'Security Engineer',     commits: 480, prs:  74, stars: 870,  badge: 'security',joined: 'Jan 2024' },
  { rank: 5,  name: 'Yuki S.',     handle: '@yukis',     avatar: '⚡',   role: 'Protocol Engineer',     commits: 440, prs:  65, stars: 760,  badge: 'core',    joined: 'Apr 2024' },
  { rank: 6,  name: 'Alex M.',     handle: '@alexm',     avatar: '🕵️',  role: 'Security Researcher',   commits: 390, prs:  58, stars: 640,  badge: 'security',joined: 'May 2024' },
  { rank: 7,  name: 'Priya N.',    handle: '@priyan',    avatar: '👩‍🔬', role: 'Crypto Researcher',     commits: 370, prs:  52, stars: 580,  badge: 'research',joined: 'Jun 2024' },
  { rank: 8,  name: 'Felix H.',    handle: '@felixh',    avatar: '🦀',   role: 'Rust Backend Dev',      commits: 340, prs:  49, stars: 510,  badge: 'core',    joined: 'Jul 2024' },
  { rank: 9,  name: 'Lena V.',     handle: '@lenav',     avatar: '📱',   role: 'Mobile Developer',      commits: 310, prs:  44, stars: 490,  badge: 'mobile',  joined: 'Aug 2024' },
  { rank: 10, name: 'Omar A.',     handle: '@omara',     avatar: '🌐',   role: 'Infra Engineer',        commits: 290, prs:  41, stars: 410,  badge: 'infra',   joined: 'Sep 2024' },
  { rank: 11, name: 'Camille B.',  handle: '@camilleb',  avatar: '🎓',   role: 'Docs Contributor',      commits: 270, prs:  38, stars: 230,  badge: 'docs',    joined: 'Sep 2024' },
  { rank: 12, name: 'Riku M.',     handle: '@rikum',     avatar: '🧩',   role: 'SDK Developer',         commits: 255, prs:  36, stars: 370,  badge: 'sdk',     joined: 'Oct 2024' },
  { rank: 13, name: 'Ana G.',      handle: '@anag',      avatar: '🔬',   role: 'QA Engineer',           commits: 240, prs:  34, stars: 280,  badge: 'qa',      joined: 'Oct 2024' },
  { rank: 14, name: 'Tom W.',      handle: '@tomw',      avatar: '⚙️',   role: 'DevOps Engineer',       commits: 225, prs:  31, stars: 310,  badge: 'infra',   joined: 'Nov 2024' },
  { rank: 15, name: 'Hana L.',     handle: '@hanal',     avatar: '🌸',   role: 'Frontend Developer',    commits: 210, prs:  29, stars: 270,  badge: 'design',  joined: 'Nov 2024' },
  { rank: 16, name: 'Diego P.',    handle: '@diegop',    avatar: '🏆',   role: 'Community Manager',     commits: 195, prs:  27, stars: 200,  badge: 'community',joined:'Dec 2024' },
  { rank: 17, name: 'Nadia B.',    handle: '@nadiab',    avatar: '🔑',   role: 'Crypto Auditor',        commits: 185, prs:  25, stars: 380,  badge: 'security',joined: 'Jan 2025' },
  { rank: 18, name: 'Jake R.',     handle: '@jaker',     avatar: '📡',   role: 'WebSocket Engineer',    commits: 175, prs:  23, stars: 290,  badge: 'core',    joined: 'Jan 2025' },
  { rank: 19, name: 'Mei Z.',      handle: '@meiz',      avatar: '💡',   role: 'Feature Developer',     commits: 165, prs:  21, stars: 220,  badge: 'sdk',     joined: 'Feb 2025' },
  { rank: 20, name: 'Karl S.',     handle: '@karls',     avatar: '🖥️',   role: 'Systems Developer',     commits: 155, prs:  19, stars: 260,  badge: 'core',    joined: 'Mar 2025' },
  { rank: 21, name: 'Rosa M.',     handle: '@rosam',     avatar: '📖',   role: 'Technical Writer',      commits: 145, prs:  17, stars: 150,  badge: 'docs',    joined: 'Mar 2025' },
  { rank: 22, name: 'Ivan P.',     handle: '@ivanp',     avatar: '🔒',   role: 'Penetration Tester',    commits: 135, prs:  15, stars: 310,  badge: 'security',joined: 'Apr 2025' },
  { rank: 23, name: 'Chloe D.',    handle: '@chloed',    avatar: '🎯',   role: 'Product Engineer',      commits: 125, prs:  13, stars: 190,  badge: 'sdk',     joined: 'May 2025' },
  { rank: 24, name: 'Sam O.',      handle: '@samo',      avatar: '🌍',   role: 'i18n Contributor',      commits: 115, prs:  11, stars: 120,  badge: 'docs',    joined: 'Jun 2025' },
  { rank: 25, name: 'Aiko T.',     handle: '@aikot',     avatar: '🤖',   role: 'AI Integrations',       commits: 105, prs:   9, stars: 240,  badge: 'core',    joined: 'Jul 2025' },
];
...
const Leaderboard = () => {
  ...
  const filtered = ALL_CONTRIBUTORS
    .filter(c =>
    ...
    <div className="min-h-screen bg-black text-white selection:bg-violet-500/30">
      ...
      <main className="relative pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-4 mb-16 max-w-2xl mx-auto items-end">
          {[ALL_CONTRIBUTORS[1], ALL_CONTRIBUTORS[0], ALL_CONTRIBUTORS[2]].map((c) => (
            <motion.div key={c.rank}
              ...
              <div className={`w-16 h-16 rounded-full bg-zinc-800 flex items-center justify-center text-3xl mb-3 ${PODIUM_RING[c.rank]}`}>
                {c.avatar}
              </div>
          ...
          {badges.map(b => (
            <button key={b} onClick={() => setBadgeFilter(b)}
              className={`px-3 py-1.5 rounded-full text-xs font-bold transition-all capitalize ${
                badgeFilter === b ? 'bg-violet-600 text-white' : 'bg-zinc-900 text-zinc-400 hover:text-white border border-white/10'
              }`}>
              {b}
            </button>
          ))}
          ...
          {filtered.map((c, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 min-w-0">
                <div className={`w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center text-xl flex-shrink-0 ${PODIUM_RING[c.rank] || ''}`}>
                  {c.avatar}
                </div>
              ...
              {/* Badge */}
              <span className={`hidden md:inline-flex text-[10px] font-bold px-2 py-1 rounded-full capitalize ${BADGE_STYLES[c.badge]}`}>
                {c.badge}
              </span>
        ...
        <div className="mt-12 text-center">
          <Link to="/community" className="inline-flex items-center gap-2 text-violet-400 hover:text-violet-300 text-sm font-medium transition-colors">
