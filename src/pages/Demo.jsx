          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-1">
                ...
                <div className="mt-6 p-4 bg-primary-950/30 border border-primary-800/50 rounded-lg">
                  <p className="text-neutral-400 text-xs leading-relaxed">
                    This demo shows symmetric encryption. Echo uses X3DH for key
                    exchange and Double Ratchet for forward secrecy in production.
                  </p>
                </div>
              </div>
              ...
              <div className="md:col-span-1">
                ...
                {showCiphertext ? (
                  <div className="p-4 bg-neutral-900 border border-primary-800/20 rounded-lg mb-4" ref={ciphertextRef}>
                    <p className="text-neutral-500 text-xs mb-2 uppercase font-bold">
                      Encrypted
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <p className="text-neutral-400 mb-4">
                  Echo uses the Extended Triple Diffie-Hellman (X3DH) protocol to establish secure channels between devices. This provides:
                </p>
                <ul className="space-y-2 text-neutral-300 text-sm">
                  <li className="flex items-start space-x-2">
                    <span className="text-primary-400 mt-1">✓</span>
                    <span>Forward secrecy: past messages stay safe even if keys are compromised</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-primary-400 mt-1">✓</span>
              ...
              <div>
                ...
                <p className="text-neutral-400 mb-4">
                  After initial key exchange, the Double Ratchet algorithm provides additional layers of security:
                </p>
                <ul className="space-y-2 text-neutral-300 text-sm">
                  <li className="flex items-start space-x-2">
                    <span className="text-primary-400 mt-1">✓</span>
                  ...
                  <li className="flex items-start space-x-2">
                    <span className="text-primary-400 mt-1">✓</span>
                    <span>DH Ratchet: periodically exchanges new Diffie-Hellman ephemeral keys</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <span className="text-primary-400 mt-1">✓</span>
                  ...
                  <li className="flex items-start space-x-2">
                    <span className="text-primary-400 mt-1">✓</span>
                    <span>Perfect forward secrecy: compromising one key doesn't break all messages</span>
                  </li>
                </ul>
              </div>
            </div>
