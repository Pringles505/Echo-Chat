        ...
        <div className="text-center mb-20">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
              {t('securitySummit.title')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">{t('securitySummit.titleHighlight')}</span>
            </h1>
        ...
        <div className="max-w-2xl mx-auto bg-zinc-900/50 border border-white/10 rounded-3xl p-8 md:p-12">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <input type="text" placeholder={t('securitySummit.form.firstName')} className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-violet-500" />
              <input type="text" placeholder={t('securitySummit.form.lastName')} className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-violet-500" />
            </div>
            <input type="email" placeholder={t('securitySummit.form.email')} className="w-full bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-violet-500" />
