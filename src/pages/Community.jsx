  ...
  const [posts, setPosts] = useState([
    {
      ...
      avatar: '👩‍💻',
      badge: 'maintainer',
      content: 'Just deployed Echo to production. The encryption performance is incredible - 99.9% throughput at 256-bit AES. No compromises.',
      timestamp: '2h ago',
      likes: 245,
      replies: 18,
    ...
    },
    {
      ...
      avatar: '🔒',
      badge: 'official',
      content: 'Security audit completed. Third-party audit from Verifide confirms X3DH implementation is correct and secure. Full report available in docs.',
      timestamp: '4h ago',
      likes: 892,
      replies: 34,
      category: 'security',
    ...
    },
    {
      ...
      avatar: '👨‍💻',
      badge: 'community',
      content: 'New SDK released: Python 0.9.0 with async support and improved typing. Feedback welcome on the new API design!',
      timestamp: '6h ago',
      likes: 156,
      replies: 23,
      category: 'devs',
          ...
          {platforms.map((platform, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div className={`w-14 h-14 rounded-2xl ${platform.color} flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-32">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {contributors.map((contributor, index) => (
                ...
                >
                  ...
                  <p className="text-violet-400 text-xs font-bold uppercase tracking-wider mb-3">{contributor.role}</p>
            ...
            <div className="mt-6 p-6 rounded-2xl bg-gradient-to-r from-violet-600/20 to-fuchsia-600/20 border border-violet-500/20 text-center">
              ...
              <p className="text-sm text-zinc-400 mb-4">{t('communityPage.contributors.ctaDesc')}</p>
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {post.badge && (
                          <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wide ${
                            post.badge === 'official' ? 'bg-violet-500/20 text-violet-300' :
                            post.badge === 'maintainer' ? 'bg-emerald-500/20 text-emerald-300' :
                      ...
                      <span className="text-sm text-zinc-500">{post.handle} • {post.timestamp}</span>
                    </div>
                  </div>
                </div>
                
                <p className="text-zinc-300 leading-relaxed mb-6 pl-13">
                  {post.content}
                </p>
